...
{{ image_modal.modal('walkthrough/walkthrough-03-create.png', 'assets/img/walkthrough/walkthrough-03-create.png', 'A screenshot of the FAC "My submissions" page. From top to bottom: A "New Audit Submission" button, a list of hyperlinks titled "Audit actions", an information banner titled "Can\'t find a report listed here?", a table titled "In progress", and a table titled "Completed".') }}
