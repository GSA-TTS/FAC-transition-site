...
### Items of note:
- <p>We've updated our UEI validation criteria to only require that an entity's UEI exists. This should reduce the number of UEI errors users experience.</p>
