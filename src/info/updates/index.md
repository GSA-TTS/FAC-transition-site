...
### Items of note:
- <p>We've updated [our UEI validation criteria](https://support.fac.gov/hc/en-us/articles/20299116907149-UEI-validation) to only require that an entity's UEI exists. This should reduce the number of UEI errors users experience.</p>
